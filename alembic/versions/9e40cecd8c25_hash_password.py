...
Revision ID: 9e40cecd8c25
Revises: c10da985962b
Create Date: 2022-04-03 00:56:57.951549
...
revision = '9e40cecd8c25'
down_revision = 'c10da985962b'
branch_labels = None
depends_on = None
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    oop.drop_index(op.f("ix_recipe_url"), table_name="recipe")
